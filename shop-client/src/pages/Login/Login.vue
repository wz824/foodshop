        ...
        <form @submit.prevent="login">
          ...
          <div :class="{on:loginWay}" @click="loginWay=true">
            ...
            <section class="login_hint">
              温馨提示：未注册824外卖帐号的手机号，登录时将自动注册，且代表已同意
        ...
        .login_header_title
          ...
          >a
            ...
            &.on
              color rgb(254,101,90)
              font-weight 700
              border-bottom 2px solid rgb(254,101,90)
      .login_content
        >form
          >div
            display none
            ...
            input
              ...
              font 400 14px Arial
              &:focus
                border 1px solid rgb(254,101,90)
            .login_message
              position relative
              margin-top 16px
              height 48px
